...
\begin{enumerate}
	...
	\item  \QCMc{La figure représente un cube ABCDEFGH. Que peut-on dire du triangle FDB ?}
	{FDB est rectangle en B.}
	{FDB est isocèle en F.}
	...
	\begin{center}
      ...
      \end{pspicture}
   \end{center}
   \item  \QCMc{La figure représente un cube ABCDEFGH. Parmi les trois droites suivantes, quelle est celle qui est orthogonale à (CD) ?}
	{(CH)}
	{(BG)}
	{(CF)} \vspace{-3em}
	\begin{center}
